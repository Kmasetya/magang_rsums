...
const Profil = () => {
    return (
        <div className="w-full bg-white font-sans">
            {/* Hero Section */}
            <section className="bg-[#F9FBF8] pt-16 pb-16 px-4 md:px-16">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="order-2 lg:order-1">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-[#6EC207]">
                            Our story, <span className="text-gray-200">Vision</span> <br />
                            <span className="text-gray-200">and values</span>
                        </h1>
            ...
            {/* Falsafah Section */}
            <section className="px-4 md:px-16 pb-16 max-w-7xl mx-auto">
            ...
            <section className="px-4 md:px-16 py-16 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <h2 className="text-4xl font-bold text-[#6EC207] mb-6 leading-tight">
                            Memberikan pelayanan terbaik demi kesehatan Anda.
                        </h2>
            ...
            {/* Misi Section */}
            <section className="bg-[#F9FBF8] px-4 md:px-16 py-16">
