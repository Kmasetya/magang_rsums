...
const Footer = () => {
    return (
        <footer className="pt-20 pb-10 bg-[#F9FBF8]">
            <div className="max-w-7xl mx-auto px-4 md:px-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols- gap-12 mb-20">
                {/* Brand Col */}
                <div className="lg:col-span-1">
                    ...
                    <div className="text-gray-500 text-sm space-y-4">
                        ...
                        <p>Alamat : Jl. Adi Sucipto No.167, Karangasem, Kec. Laweyan,<br /> Kota Surakarta, Jawa Tengah 57145</p>
                    </div>
                </div>
